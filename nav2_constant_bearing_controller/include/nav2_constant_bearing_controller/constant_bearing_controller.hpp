...
#ifndef NAV2_CONSTANT_BEARING_CONTROLLER__CONSTANT_BEARING_CONTROLLER_HPP_
#define NAV2_CONSTANT_BEARING_CONTROLLER__CONSTANT_BEARING_CONTROLLER_HPP_
...
/**
 * @class nav2-controller-comparison/nav2_constant_bearing_controller::ConstantBearingController
 * @brief Regulated pure pursuit controller plugin
 */
class ConstantBearingController : public nav2_core::Controller
{
public:
  /**
   * @brief Constructor for nav2-controller-comparison/nav2_constant_bearing_controller::ConstantBearingController
   */
  ConstantBearingController() = default;

  /**
   * @brief Destrructor for nav2-controller-comparison/nav2_constant_bearing_controller::ConstantBearingController
   */
  ~ConstantBearingController() override = default;
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("ConstantBearingController")};
  ...
  geometry_msgs::msg::PoseStamped plan_center;
...
}  // namespace nav2-controller-comparison/nav2_constant_bearing_controller

#endif  // NAV2_CONSTANT_BEARING_CONTROLLER__CONSTANT_BEARING_CONTROLLER_HPP_